		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Global DB in S4",
									"targetURL": "#comrenesaszsde990-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrenesaszsde990-display": {
								"semanticObject": "comrenesaszsde990",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.renesas.zsde990",
									"url": sap.ui.require.toUrl("com/renesas/zsde990")
								}
							}
						}
					}
